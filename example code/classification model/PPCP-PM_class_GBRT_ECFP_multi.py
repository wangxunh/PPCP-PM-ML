# -*- coding: utf-8 -*-
"""
Created on Thu Jul 11 20:37:29 2024
...
# These should be the original raw values, not pre-encoded.
categorical_cols = [
...
best_params_last = None  # keep last chosen params to reuse if needed
...
for run in range(n_runs):
    ...
    for train_index, test_index in kf.split(features):
        ...
        for p in gbr_param_list:
            model_val = GradientBoostingClassifier(**p)
        ...
        sens, spec = calculate_sensitivity_specificity(test_targets, predictions)
